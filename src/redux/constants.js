export default {
  ...
  REMAINING_DATA_GET: 'REMAINING_DATA_GET',
  ...
  GET_SUBSCRIPTIONSTATUS: 'GET_SUBSCRIPTIONSTATUS',
  MAINTAINENCE: 'MAINTAINENCE',
  OVER_MODEL_VIEW:'OVER_MODEL_VIEW',
  OVERUSAGE_COUNT:'OVERUSAGE_COUNT',
  LOCATION_ID:'LOCATION_ID',
  SET_PUCHASE_ALL_PLANS:'SET_PUCHASE_ALL_PLANS',
  SUBSCRIPTION_CANCEL_STATUS:'SUBSCRIPTION_CANCEL_STATUS',
};
